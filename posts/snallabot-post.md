...
Finally, I had every step I needed to connect to EA servers myself. There was nothing missing I had figured out every detail at this point! I thought this would be the easiest part, recreating this entire workflow in my own bot. As the saying goes, the last 20% of a project is 80% of the work. I feel like everyday I am met with the reality of this statement. Even thought I successfully reverse engineered everything, I had to write more than 1000 lines of code to integrate this fully. Here are some highlights of issues I found and had to fix:
