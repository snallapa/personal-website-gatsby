...
export default ({ location }) => {
    ...
    useEffect(() => {
        const login = async () => {
            ...
            const res2 = await fetch(`https://accounts.ea.com/connect/tokeninfo?access_token=${access_token}`, {
                headers: {
                    'User-Agent': 'ProtoHttp 1.3/DS 15.1.2.2.0 (Android)',
            ...
            const res3 = await fetch(`https://gateway.ea.com/proxy/identity/pids/${pid}/personas?access_token=${access_token}&status=ACTIVE`, {
                headers: {
                    'User-Agent': 'ProtoHttp 1.3/DS 15.1.2.2.0 (Android)',
                    'Content-Type': 'application/json;charset=utf-8',
                    'Accept': 'application/json;charset=utf-8',
            ...
            const res4 = await fetch(`https://gateway.ea.com/proxy/identity/pids/${pid}/entitlements?status=ACTIVE`, {
                headers: {
                    'User-Agent': 'ProtoHttp 1.3/DS 15.1.2.2.0 (Android)',
                    'Content-Type': 'application/json;charset=utf-8',
            ...
            const res5 = await fetch(`https://accounts.ea.com/connect/auth?response_type=code&redirect_uri=http://127.0.0.1/success&machineProfileKey=1d6830c75f0f5a26&release_type=prod&access_token=${access_token}&persona_id=${personaId}&client_id=MaddenCompanionApp19`, {
                headers: {
                    'User-Agent': 'ProtoHttp 1.3/DS 15.1.2.2.0 (Android)',
                    'Content-Type': 'application/json;charset=utf-8',
                    'Accept': 'application/text',
            ...
            const res7 = await fetch(`https://accounts.ea.com/connect/tokeninfo?access_token=${access_token2}`, {
                headers: {
                    'User-Agent': 'ProtoHttp 1.3/DS 15.1.2.2.0 (Android)',
                    'Content-Type': 'application/json;charset=utf-8',
                    'Accept': 'application/text'
            ...
            const res8 = await fetch(`https://accounts.ea.com/connect/auth?response_type=code&redirect_uri=http://127.0.0.1/success&machineProfileKey=1d6830c75f0f5a26&release_type=prod&access_token=${access_token2}&persona_id=${personaId}&client_id=${SYSTEM_MAP[system]}`, {
                headers: {
                    'User-Agent': 'ProtoHttp 1.3/DS 15.1.2.2.0 (Android)',
                    'Content-Type': 'application/json;charset=utf-8',
                    'Accept': 'application/text',
            ...
            const res9 = await fetch(`https://wal2.tools.gos.bio-iad.ea.com/wal/authentication/login`, {
                method: 'POST',
                headers: {
                    'User-Agent': 'ProtoHttp 1.3/DS 15.1.2.2.0 (Android)',
    ...
    }, [state.loading, state.blazeSession]);

    return (
        <div> {state.loading ? "Loading" : state.blazeSession} </div>
    )
